...
<div class="container-fluid px-4 mt-5">
    ...
    <div class="row">
        <div class="col-lg-4 mx-auto">
            <div class="card bg-danger text-white mb-4"><p class="h5 p-3 text-center">Admin <a class="text-center text-warning stretched-link" href="index-admin.php">Login Here</a></p>
        </div>
    </div>
